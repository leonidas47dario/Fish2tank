 ...
 *
 * The catalog has BOTH adult size and minimum tank for 92 of 2,178 species.
 * Nineteen tiles in twenty drew a card format whose whole structure was three
 * numbers, and had at most one of them. What the format promised and what the
 * library contains were not the same shape.
 *
 * The spec 003 care backfill moved one of those numbers and not the other:
 * adult size is now recorded for 689 species rather than 47, while minimum
 * tank volume is still 92. That makes the case for a conditional line stronger,
 * not weaker - the tiles now differ from each other in which facts they have,
 * so a fixed three-slot layout would draw a gap on almost every one.
 *
