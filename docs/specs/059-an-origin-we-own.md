...
**Introduces:** ENH-23. (Filed as ENH-22 when written; renumbered on landing,
because this spec and spec 061 were written in parallel on separate branches and
both claimed the same free id, and ENH-22 has since been taken by something
else. See spec 001, "The specs that never landed".)
